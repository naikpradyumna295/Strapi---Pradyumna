...
![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.001.png)
...
1. Setting up the Github Action
   ...
   ![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.002.png)

   Create Workflow and run the build

   ![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.003.png)

   Once it is success it will show below

   ![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.004.png)


We can see the application is running 

![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.005.png)

![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.006.png)

Click on Create first administator.

![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.007.png)

Fill all the details and click on lets’ start.

![](./images/Aspose.Words.2ec5cb76-f0d3-42d3-b7d9-323ce2de99b3.008.png)
